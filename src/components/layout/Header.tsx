    ...
    >
      <div className="container-x flex h-20 items-center justify-between gap-4 md:h-24">
        ...
        <div className="hidden shrink-0 items-center gap-2 lg:flex">
          <Link
            to="/partner-with-us"
            className="inline-flex shrink-0 items-center justify-center whitespace-nowrap rounded-full bg-navy px-4 py-2.5 text-xs font-semibold text-white shadow-sm transition hover:bg-navy-dark xl:px-5 xl:text-sm"
          >
            Partner With Us
          </Link>
          <Link
            to="/contact"
            className="hidden min-w-[10rem] shrink-0 items-center justify-center gap-1.5 whitespace-nowrap rounded-full bg-orange px-5 py-2.5 text-sm font-semibold text-white shadow-glow transition hover:brightness-110 xl:inline-flex"
          >
          ...
          <div className="absolute right-0 top-0 h-full w-[86%] max-w-sm overflow-y-auto bg-white shadow-xl animate-in slide-in-from-right">
            ...
            <nav className="p-3">
              ...
              <Link
                to="/partner-with-us"
                onClick={() => setOpen(false)}
                className="mt-4 flex items-center justify-center rounded-full bg-navy px-4 py-3 text-sm font-semibold text-white"
              >
                Partner With Us
              </Link>
              <Link
                to="/contact"
                onClick={() => setOpen(false)}
                className="mt-2 flex items-center justify-center rounded-full bg-orange px-4 py-3 text-sm font-semibold text-white"
              >
                Get Free Consultation
              </Link>
            </nav>
